"""
Figure 2D — Step 2: process data.

Constructs the real orthonormal Fourier basis for N=4, defines smooth_func,
and projects it onto the basis to obtain Fourier coefficients C_smooth (4×4).
...
# Build basis items (same as figure_2C)
items = []
