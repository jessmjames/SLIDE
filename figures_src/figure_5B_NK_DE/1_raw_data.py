"""
Figure 5B — Step 1: raw simulation data for NK directed evolution (smooth, K=1).
...
Usage
-----
  python figures_src/figure_5B_NK_DE/1_raw_data.py

Note: requires a GPU (via the delegated 5A script).

Shared raw data: outputs are also used by Figs 5A and 5C.
"""
