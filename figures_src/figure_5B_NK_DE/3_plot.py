"""
Figure 5B — Step 3: plot directed evolution on smooth NK landscape (N=45, K=1).
...
Output
------
  figures/N45K1_DE_fitness.pdf
  figures/N45K1_DE_strategy_space.pdf

Usage
-----
  python figures_src/figure_5B_NK_DE/3_plot.py

Originally from ruggedness_figures_plots.ipynb cells 49, 50.
"""
...
out_path = os.path.join(figures_dir, 'N45K1_DE_fitness.pdf')
plt.savefig(out_path, dpi=dpi)
print(f'Saved -> {out_path}')

# --- Cell 50: N45K1 strategy space ---
...
out_path = os.path.join(figures_dir, 'N45K1_DE_strategy_space.pdf')
plt.savefig(out_path, dpi=dpi)
print(f'Saved -> {out_path}')
