"""
Figure 5D — Step 2: process GB1 directed evolution data.
...
(ruggedness_figures_data_processing.ipynb) across several cells:
  ...
  Cell 113 — run GB1 strategy selection and DE test, save plot_data/GB1_strategy_selection.pkl
...
------
  plot_data/empirical_lookup.pkl
    ...
    — shared lookup table for Figs 5D, 5E, 5F
...
Usage
-----
  Run ruggedness_figures_data_processing.ipynb cells 106-113 in order.
  (No standalone script; processing is embedded in the notebook.)
"""

print("Processing is done in ruggedness_figures_data_processing.ipynb cells 106-113.")
print("Outputs:")
print("  plot_data/empirical_lookup.pkl  (shared with Figs 5E, 5F)")
print("  plot_data/GB1_strategy_selection.pkl")
